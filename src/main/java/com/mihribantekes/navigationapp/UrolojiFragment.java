 ...
 */
public class UrolojiFragment extends Fragment {


    public UrolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_uroloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/1873d");// JSONTask classımızı çağırdık
