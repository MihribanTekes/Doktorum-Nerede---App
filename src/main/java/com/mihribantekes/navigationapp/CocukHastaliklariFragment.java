 ...
 */
public class CocukHastaliklariFragment extends Fragment {


    public CocukHastaliklariFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_cocuk_hastaliklari, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/oth7");// JSONTask classımızı çağırdık
