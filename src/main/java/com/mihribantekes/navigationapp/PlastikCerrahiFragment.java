 ...
 */
public class PlastikCerrahiFragment extends Fragment {


    public PlastikCerrahiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_plastik_cerrahi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/1tezd");// JSONTask classımızı çağırdık
