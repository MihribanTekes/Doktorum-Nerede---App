 ...
 */
public class PatolojiFragment extends Fragment {


    public PatolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_patoloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/15mi1");// JSONTask classımızı çağırdık
