 ...
 */
public class AnesteziFragment extends Fragment {


    public AnesteziFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_anestezi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/3b7pl");// JSONTask classımızı çağırdık
