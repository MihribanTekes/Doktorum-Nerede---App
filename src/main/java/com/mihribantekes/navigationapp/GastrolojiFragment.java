 ...
 */
public class GastrolojiFragment extends Fragment {


    public GastrolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_gastroloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/4x7l7");// JSONTask classımızı çağırdık
