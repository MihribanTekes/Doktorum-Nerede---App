 ...
 */
public class CildiyeFragment extends Fragment {


    public CildiyeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_cildiye, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/15jbv");// JSONTask classımızı çağırdık
