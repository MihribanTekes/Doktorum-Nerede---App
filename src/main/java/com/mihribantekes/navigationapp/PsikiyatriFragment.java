 ...
 */
public class PsikiyatriFragment extends Fragment {


    public PsikiyatriFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_psikiyatri, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/4m5ix");// JSONTask classımızı çağırdık
