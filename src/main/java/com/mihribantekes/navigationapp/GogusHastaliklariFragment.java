 ...
 */
public class GogusHastaliklariFragment extends Fragment {


    public GogusHastaliklariFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_gogus_hastaliklari, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/3swyz");// JSONTask classımızı çağırdık
    ...
    public class JSONTask extends AsyncTask<String,String,List<PersonelModel>>// JSON parse etme classı
    {
        ...
        protected List<PersonelModel> doInBackground(String... params) {
            ...
            try {
                ...
                stream = connection.getInputStream();//bağlantı kuruldu
