 ...
 */
public class BiyokimyaFragment extends Fragment {


    public BiyokimyaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_biyokimya, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/3h4l7");// JSONTask classımızı çağırdık
