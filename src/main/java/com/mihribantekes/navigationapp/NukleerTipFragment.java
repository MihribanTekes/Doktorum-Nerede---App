 ...
 */
public class NukleerTipFragment extends Fragment {


    public NukleerTipFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_nukleer_tip, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/4wnm1");// JSONTask classımızı çağırdık
