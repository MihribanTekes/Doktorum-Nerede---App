 ...
 */
public class GogusCerrahiFragment extends Fragment {


    public GogusCerrahiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_gogus_cerrahi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/3uuez");// JSONTask classımızı çağırdık
