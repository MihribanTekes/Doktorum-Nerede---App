 ...
 */
public class KardiyolojiFragment extends Fragment {


    public KardiyolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_kardiyoloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/2ef5l");// JSONTask classımızı çağırdık
