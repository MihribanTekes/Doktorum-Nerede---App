 ...
 */
public class CocukCerrahiFragment extends Fragment {


    public CocukCerrahiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_cocuk_cerrahi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/2l6wb");// JSONTask classımızı çağırdık
