 ...
 */
public class GozHastaliklariFragment extends Fragment {


    public GozHastaliklariFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_goz_hastaliklari, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/y8zf");// JSONTask classımızı çağırdık
