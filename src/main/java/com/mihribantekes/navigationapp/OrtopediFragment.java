 ...
 */
public class OrtopediFragment extends Fragment {


    public OrtopediFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ortopedi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/59ikp");// JSONTask classımızı çağırdık
