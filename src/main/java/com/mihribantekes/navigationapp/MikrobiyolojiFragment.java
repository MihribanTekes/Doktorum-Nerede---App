 ...
 */
public class MikrobiyolojiFragment extends Fragment {


    public MikrobiyolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_mikrobiyoloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/1dzfd");// JSONTask classımızı çağırdık
