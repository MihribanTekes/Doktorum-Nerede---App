 ...
 */
public class GenelCerrahiFragment extends Fragment {


    public GenelCerrahiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_genel_cerrahi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/2lu1n");// JSONTask classımızı çağırdık
