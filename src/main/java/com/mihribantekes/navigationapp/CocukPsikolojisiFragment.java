 ...
 */
public class CocukPsikolojisiFragment extends Fragment {


    public CocukPsikolojisiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_cocuk_psikolojisi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/1ce8r");// JSONTask classımızı çağırdık
