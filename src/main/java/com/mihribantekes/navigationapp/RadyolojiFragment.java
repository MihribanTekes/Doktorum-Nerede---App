 ...
 */
public class RadyolojiFragment extends Fragment {


    public RadyolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_radyoloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/1p4nt");// JSONTask classımızı çağırdık
