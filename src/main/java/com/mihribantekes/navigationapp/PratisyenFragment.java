 ...
 */
public class PratisyenFragment extends Fragment {


    public PratisyenFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_pratisyen, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/4hv7d");// JSONTask classımızı çağırdık
