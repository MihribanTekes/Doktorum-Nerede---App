 ...
 */
public class EnfeksiyonFragment extends Fragment {


    public EnfeksiyonFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_enfeksiyon, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/53fcr");// JSONTask classımızı çağırdık
