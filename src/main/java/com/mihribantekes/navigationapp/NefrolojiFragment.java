 ...
 */
public class NefrolojiFragment extends Fragment {


    public NefrolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_nefroloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/4hfrt");// JSONTask classımızı çağırdık
