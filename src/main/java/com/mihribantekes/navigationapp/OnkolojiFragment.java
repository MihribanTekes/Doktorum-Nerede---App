 ...
 */
public class OnkolojiFragment extends Fragment {


    public OnkolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_onkoloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/3asa1");// JSONTask classımızı çağırdık
