 ...
 */
public class HematolojiFragment extends Fragment {


    public HematolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_hematoloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/5cuuz");// JSONTask classımızı çağırdık
