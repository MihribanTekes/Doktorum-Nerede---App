 ...
 */
public class NorolojiFragment extends Fragment {


    public NorolojiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_noroloji, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/1op89");// JSONTask classımızı çağırdık
