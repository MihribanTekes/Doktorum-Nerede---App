 ...
 */
public class EndokrinFragment extends Fragment {


    public EndokrinFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_endokrin, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/29x49");// JSONTask classımızı çağırdık
