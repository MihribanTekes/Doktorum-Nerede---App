 ...
 */
public class KadinDogumFragment extends Fragment {


    public KadinDogumFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_kadin_dogum, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/s1zn");// JSONTask classımızı çağırdık
