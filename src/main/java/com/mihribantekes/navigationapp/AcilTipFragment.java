 ...
 */
public class AcilTipFragment extends Fragment {


    public AcilTipFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_acil_tip, container, false); // oluşturulduğunda görünebilmesi için onCreate View
        // hazır metodu içerisine classın kendine ait fragmentın tanımladık



        new JSONTask().execute("https://api.myjson.com/bins/4rmyz"); // JSONTask classımızı çağırdık
    ...
    public class JSONTask extends AsyncTask<String,String,List<PersonelModel>> // JSON parse etme classı
    {
        ...
        protected List<PersonelModel> doInBackground(String... params) {
            ...
            try {
                ...
                reader = new BufferedReader(new InputStreamReader(stream)); //okuduk
                ...
                List<PersonelModel> personelModelList = new ArrayList<>(); //JOSN veriler için liste oluşturduk
        ...
        protected void onPostExecute(List<PersonelModel> result) {
            ...
            lvPersonel.setAdapter(adapter); // adapterle listviewi bağldık
    ...
    public class PersonelAdapter extends ArrayAdapter //adapter classı
    {
        ...
        @Override
        public View getView(int position, View convertView, ViewGroup parent) { // metodun yaptığı iş satırları çizdirmek
            ...
            ImageLoader.getInstance().displayImage("http://i.hizliresim.com/go7bpQ.jpg", holder.ivResim, new ImageLoadingListener() {
                ...
                public void onLoadingStarted(String s, View view) {
                    progressBar.setVisibility(View.VISIBLE); // progress barı görünür yap dolarken
                }

                @Override
                public void onLoadingFailed(String s, View view, FailReason failReason) {
                    progressBar.setVisibility(View.GONE); // progress barı görünmez yap hatada
                }

                @Override
                public void onLoadingComplete(String s, View view, Bitmap bitmap) {
                    progressBar.setVisibility(View.GONE); // progress barı görünmez yap dolduğunda
                }

                @Override
                public void onLoadingCancelled(String s, View view) {
                    progressBar.setVisibility(View.GONE); // progress barı görünmez yap yüklenme iptal edildiğinde
                }
            });
