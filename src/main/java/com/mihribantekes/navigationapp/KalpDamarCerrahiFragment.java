 ...
 */
public class KalpDamarCerrahiFragment extends Fragment {


    public KalpDamarCerrahiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_kalp_damar_cerrahi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/1bk5f");// JSONTask classımızı çağırdık
