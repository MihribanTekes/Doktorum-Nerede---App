 ...
 */
public class BeyinCerrahiFragment extends Fragment {


    public BeyinCerrahiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_beyin_cerrahi, container, false);

        new JSONTask().execute("https://api.myjson.com/bins/2n4cb");
